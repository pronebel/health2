                    ...
                    var POPUP_TPL = [
                        '<div class="china-city-container">',
                            ...
                            '<ion-content class="has-header has-header">',
                                ...
                                '<div class="item item-divider">定位</div>',
                                ...
                                '<div ng-repeat="(pinyin, Citys) in CityList">',
                                    '<div class="item item-divider">{{pinyin}}</div>',
                                    '<div class="item" ng-click="selectLocation(City)" ng-repeat="City in Citys">',
